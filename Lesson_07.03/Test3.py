...
if flat_num < 1 or flat_num > 144:
    print("Вы ввели некорректный номер квартиры! В этом доме расположены квартиры 1-144 !")
if 1 <= flat_num <= 36:
    print("1-й подъезд")
    floor = (flat_num - 1)//4 + 1
if 37 <= flat_num <= 72:
    print("2-й подъезд")
    floor = (flat_num - 37)//4 + 1
if 73 <= flat_num <= 108:
    print("3-й подъезд")
    floor = (flat_num - 73)//4 + 1
if 109 <= flat_num <= 144:
    print("4-й подъезд")
    floor = (flat_num - 109)//4 + 1
print(floor, "этаж")